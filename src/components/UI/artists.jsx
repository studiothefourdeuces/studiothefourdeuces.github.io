...
const Artists = () => {
  ...
  const artists = [
    { name: "Max", role: "Resident Artist", instagram: "https://www.instagram.com/maxxonk_tattoo/", styles: [{ name: "Chicano" }, { name: "Realism" }, { name: "Neo-Traditional" }], image: "/src/assets/images/max.png", works: ["/src/assets/images/works/max1.jpg", "/src/assets/images/works/max2.jpg", "/src/assets/images/works/max3.jpg", "/src/assets/images/works/max4.jpg"] },
    { name: "Eugene", role: "Resident Artist", instagram: "https://www.instagram.com/novohatskytattoo/", styles: [{ name: "Chicano" }, { name: "Realism" }, { name: "Neo-Traditional" }], image: "/src/assets/images/eugene.png", works: ["/src/assets/images/works/eugene1.jpg", "/src/assets/images/works/eugene2.jpg", "/src/assets/images/works/eugene3.jpg", "/src/assets/images/works/eugene4.jpg"] },
